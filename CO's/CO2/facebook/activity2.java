    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(user.equals(""))
                {
                    Toast.makeText(Activity2.this, "Enter your username", Toast.LENGTH_SHORT).show();
                }
                else if(mail.equals(""))
                {
                    Toast.makeText(Activity2.this, "Enter your email", Toast.LENGTH_SHORT).show();
                }
                else if(phn.equals(""))
                {
                    Toast.makeText(Activity2.this, "Enter your phone number", Toast.LENGTH_SHORT).show();
                }
                else if(ag.equals(""))
                {
                    Toast.makeText(Activity2.this, "Enter your age", Toast.LENGTH_SHORT).show();
                }
                else if(gndr==-1)
                {
                    Toast.makeText(Activity2.this, "Enter your gender", Toast.LENGTH_SHORT).show();
                }
                else if(sp.equals("Select your degree"))
                {
                    Toast.makeText(Activity2.this, "Enter your degree", Toast.LENGTH_SHORT).show();
                }
                else if(pswd.equals(""))
                {
                    Toast.makeText(Activity2.this, "Enter your password", Toast.LENGTH_SHORT).show();
                }
                else
                {
